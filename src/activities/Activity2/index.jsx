  ...
  return (
    <WorldBackground activityId={2}>
          ...
          <AnimatePresence>
            {feedback && (
              <motion.div
                ...
                className={`mt-6 text-center text-xl font-black rounded-2xl p-4 ${feedback === 'correct' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-500'
                  }`}
              >
      ...
      <SuccessModal
        ...
        onContinue={() => { completeActivity(2, score, sessionMistakes); setShowSuccess(false); setCount(0); setScore(0); setSessionMistakes(0); nextSyllable(false); }}
      />
    </WorldBackground>
  );
}
