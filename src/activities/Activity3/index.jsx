  ...
  return (
    <WorldBackground activityId={3}>
      ...
      <div className="max-w-xl mx-auto">
        ...
        >
          ...
          <input
            ...
            className={`input-word mb-4 ${
              feedback === 'wrong' ? 'shake border-red-400' :
        ...
        <AnimatePresence>
          {feedback && (
            <motion.div
              ...
              className={`text-center text-xl font-black rounded-2xl p-4 ${
      ...
      <SuccessModal
        ...
        onContinue={() => { completeActivity(3, score); setShowSuccess(false); setCount(0); setScore(0); setLevel(1); nextWord(1, false); }}
      />
    </WorldBackground>
  );
}
