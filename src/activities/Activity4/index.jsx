  ...
  return (
    <WorldBackground activityId={4}>
            ...
            {images.map((img, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white rounded-3xl shadow-xl p-4 border-4 transition-all duration-300 ${fb === 'correct' ? 'border-green-400 shadow-green-200/50' :
                ...
                >
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="¿Qué es?"
                      disabled={fb === 'correct'}
                      className={`input-word text-xl w-full ${fb === 'correct' ? 'bg-green-50 border-green-400 text-green-600' :
      ...
      <SuccessModal
        ...
        onContinue={() => {
          completeActivity(4, score, sessionMistakes);
